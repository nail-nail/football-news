...
from main.views import add_news_entry_ajax, create_news_flutter, delete_news, edit_news, logout_user, proxy_image, register, login_user, show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id
